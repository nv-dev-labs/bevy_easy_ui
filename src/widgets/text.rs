...
impl EasyText {
    ...
    pub fn font_family(mut self, text_font: Handle<Font>) -> Self {
    ...
    pub fn smoothing(mut self, font_smoothing: FontSmoothing) -> Self {
        self.2.font_smoothing = font_smoothing;
        self
    }

    pub fn features(mut self, font_features: FontFeatures) -> Self {
